...
const Contact = () => {
  return (
    <Layout bodyClass={"contact"}>
      <PageBanner pageName={"Liên Hệ"} pageTitle={"Liên Hệ"} />
            ...
            <div className="col-12">
              <div className="title-heading st-2">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <LeftArrow />
                  <span className="inner-sub st-1">Hỗ trợ thông tin</span>
                  <RightArrow />
                </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="title-heading">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <span className="inner-sub">Liên hệ ngay</span>
                  <RightArrow />
                </div>
              ...
              <div className="wrap-contact">
                <div className="fx adress">
                  ...
                  <div className="content">
                    <p>Địa chỉ</p>
                    <h4>Thôn Tân Trung - Ea Kênh, Krông Păc- Đăk Lăk</h4>
                  </div>
                </div>
                <div className="fx Email">
                  ...
                  <div className="content">
                    <p>Email</p>
                    <h4>maugiaohoami_dl@gmail.com</h4>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-message">
                <h2 className="heading">Để lại tin nhắn</h2>
                <form
                  ...
                  <div className="fx flex-wrap">
                    ...
                    <fieldset className="select-wrap" role="group">
                      <div className="select">
                        <select name="subject" id="subject">
                          <option value="Please Select">Lớp học</option>
                          <option value="services2">Lớp cho trẻ 03 đến 12 tháng tuổi </option>
                          <option value="services2">Lớp cho trẻ 13 đến 24 tháng tuổi </option>
                          <option value="services2">Lớp cho trẻ 25 đến 36 tháng tuổi </option>
                          <option value="services1">Lớp Mẫu giáo 3-4 tuổi</option>
                          <option value="services2">Lớp Mẫu giáo 4-5 tuổi</option>
                          <option value="services1">Lớp Mẫu giáo 5-6 tuổi</option>
                    ...
                    <div className="wrap-btn">
                      <button type="submit" className="fl-btn st-6">
                        <span className="inner">Gửi tin nhắn</span>
                      </button>
                    </div>
                  </div>
                </form>
