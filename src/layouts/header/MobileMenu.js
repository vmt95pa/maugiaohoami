        ...
        >
          <ul className="menu" id="mainnav">
            ...
            <li className="menu-item-has-children">
              ...
              <span
                className={`btn-submenu ${activeBtn(navigatorData.TIME_TABLE.title)}`}
                onClick={() => activeMenuSet(navigatorData.TIME_TABLE.title)}
              />
              <ul className="sub-menu" style={activeLi(navigatorData.TIME_TABLE.title)}>
                {navigatorData.TIME_TABLE.subMenu.map((item, index) => (
                  <li className="inner-menu-item" key={index}>
                    <Link href={item.href}>
                      <a>{item.title}</a>
                    </Link>
                  </li>
            ...
            <li className="menu-item-has-children">
              ...
              <span
                className={`btn-submenu ${activeBtn(navigatorData.PARENT.title)}`}
                onClick={() => activeMenuSet(navigatorData.PARENT.title)}
              />
              <ul className="sub-menu" style={activeLi(navigatorData.PARENT.title)}>
